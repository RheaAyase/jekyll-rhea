...
Game development after Red Hat was a bit more boring. Notably I owned core C++ features that will land in multiple future 3A multiplayer games. Cross-project and cross-team work. I did not enjoy this work and I'd love to get back into Open Source and/or Linux world.

{% include spacer.html %}

{% include image.html
  img="assets/speaker/2018_devconf.jpg"
  title="Photo of Rhea presenting about Open Source .NET at a conference."
  caption="Presenting about Open Source .NET at a conference."
  align="left"
  float="true"
  border="1px"
  width="50%"
...
{% include image.html
  ...
  caption="Participating in a Special Effect charity."
  align="right"
  float="true"
  border="1px"
  width="50%"
