...
- This will cover the intel ones:
```
...
- Clone (into whatever location you want):
```
...
I'll strongly recommend you to look into [chezmoi](https://www.chezmoi.io) (rpm) and [ble.sh](https://github.com/akinomyoga/ble.sh) (mentioned above) :) (fish is stinky and zsh often crashes)
...
**QT themes**
- Create the probably missing directory
```
mkdir -p ~/.config/environment.d
```
- Cook up the ocnfig: `~/.config/environment.d/niri.conf` 
```
